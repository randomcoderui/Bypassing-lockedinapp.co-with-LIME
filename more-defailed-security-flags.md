...
1st flag: this checks for notification listeners.
...
2nd flag: this checks for overlay capable apps
...
3rd flag: Power saver (battery saver) check, this checks if battery saver is on
...
4th flag: duplicate app detected, this checks for cloned apps through process cmd line
...
5th flag: root detection & custom rom detection
...
7th flag: secondary display (screen casting) detected
...
8th flag: SELinux policy check, if it returns permisssive, then it flags as bypass
...
9th flag: Sim card detection, this is used to determine if the phone is a burner, and this could cause alot of false alarms
...
10th flag: checks for usb devices, wall chargers dont count, but if you connect your phone to a pc, it will trip this flag
...
11th flag: this checks for custom certificates
...
12th flag: checks for bootloader unlock
...
14th flag: this is just play integrity lol
...
15th flag: suspicious accessiblity apps/services
...
16th flag: checks for usb debugging or ADB
...
17th flag: airplane mode detection
...
18th flag: APK tamper detection
...
19th flag: App cloner detection
...
20th flag: app has been disabled detection
...
21th flag: app standby bucket thing
...
22nd flag: checks for manual time change to try to trick servers
...
23rd flag: background restriction thing
...
24th flag: what the fuck is this sonion
...
27th flag: debugger (frida) detection
...
28th layer: developer settings enabled (brochacho why)
...
29th layer: third party device admin apps detection thing
...
30th flag (holy shit why so serious): secondary burner phone detection
...
32nd flag: xposed lsposed edsposed detection
...
33rd flag: sideloader detection
...
34th flag: location downgrade trigger, this happens if you activate battery saver btw
...
35th flag: mock location detection
...
36th flag: secondary profile/account detection
...
37th flag: network proxy detection
...
FINALLY IM DONE WITH THIS SHIT, anyways thats like 38 different security checks, 38 is actually alot, and some of them can cause false alarms, ok its time to go to bed for me cya
