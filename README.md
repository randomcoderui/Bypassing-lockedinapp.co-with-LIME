...
# tiny note: LIME is also compatiable with apatch, and matter of fact, apatch works even better because it alters the kernel space instead of user space where apps live, idk how to really explain it well but thats my interpretation
