...
.method public static final a(Ljava/util/ArrayList;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/CollectionsKt;->S(Ljava/util/List;Ljava/util/Comparator;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lokio/Path;->b()Lokio/Path;
...
.method public static final c(Lokio/RealBufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-virtual {v5}, Lokio/RealBufferedSource;->p()I
    ...
    invoke-virtual {v5}, Lokio/RealBufferedSource;->G()S
    ...
    iput-wide v2, v6, Lkotlin/jvm/internal/Ref$LongRef;->a:J
    ...
    iput-wide v2, v4, Lkotlin/jvm/internal/Ref$LongRef;->a:J
    ...
    invoke-virtual {v5, v1, v2}, Lokio/RealBufferedSource;->X(J)V
    ...
    invoke-virtual {v5, v0, v1}, Lokio/RealBufferedSource;->M(J)Ljava/lang/String;

    move-result-object v15

    invoke-static {v15, v8}, Lkotlin/text/StringsKt;->m(Ljava/lang/CharSequence;C)Z
    ...
    :goto_3
    iget-wide v12, v6, Lkotlin/jvm/internal/Ref$LongRef;->a:J
    ...
    invoke-static {v5, v9, v0}, Lokio/internal/ZipFilesKt;->d(Lokio/RealBufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-virtual {v1, v15}, Lokio/Path;->e(Ljava/lang/String;)Lokio/Path;

    move-result-object v3

    invoke-static {v15, v0, v8}, Lkotlin/text/StringsKt;->p(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v0

    new-instance v2, Lokio/internal/ZipEntry;

    iget-wide v8, v6, Lkotlin/jvm/internal/Ref$LongRef;->a:J

    iget-wide v12, v4, Lkotlin/jvm/internal/Ref$LongRef;->a:J

    iget-wide v6, v7, Lkotlin/jvm/internal/Ref$LongRef;->a:J
...
.method public static final d(Lokio/RealBufferedSource;ILkotlin/jvm/functions/Function2;)V
    ...
    invoke-virtual {p0}, Lokio/RealBufferedSource;->G()S
    ...
    invoke-virtual {p0, v4, v5}, Lokio/RealBufferedSource;->W(J)V
    ...
    invoke-interface {p2, v9, v10}, Lkotlin/jvm/functions/Function2;->o(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v6, v9, v10}, Lokio/Buffer;->J0(J)V
...
.method public static final e(Lokio/RealBufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-virtual {p0}, Lokio/RealBufferedSource;->p()I
    ...
    invoke-virtual {p0, v4, v5}, Lokio/RealBufferedSource;->X(J)V
    ...
    invoke-virtual {p0, v6, v7}, Lokio/RealBufferedSource;->X(J)V
    ...
    invoke-virtual {p0, v2, v3}, Lokio/RealBufferedSource;->X(J)V
