...
.method public final F0(Lokio/Buffer;J)J
    ...
    :goto_0
    iget-object v6, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->f:Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-boolean v7, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->b:Z
    ...
    :cond_1
    :goto_1
    iget-boolean v8, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->e:Z

    if-nez v8, :cond_8

    iget-object v8, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:Lokio/Buffer;
    ...
    invoke-virtual {v8, v1, v9, v10}, Lokio/Buffer;->F0(Lokio/Buffer;J)J
    ...
    iget-object v4, v4, Lokhttp3/internal/http2/Http2Connection;->t:Lokhttp3/internal/http2/Settings;
    ...
    :goto_3
    :try_start_c
    iget-object v1, v6, Lokhttp3/internal/http2/Http2Stream;->k:Lokhttp3/internal/http2/Http2Stream$StreamTimeout;
