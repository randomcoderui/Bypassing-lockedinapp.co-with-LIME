...
.method public final R(Lretrofit2/Callback;)V
    ...
    :try_start_0
    iget-boolean v0, p0, Lretrofit2/OkHttpCall;->k:Z

    if-nez v0, :cond_3

    const/4 v0, 0x1

    iput-boolean v0, p0, Lretrofit2/OkHttpCall;->k:Z
    ...
    invoke-interface {v0, v1}, Lokhttp3/Call;->G(Lokhttp3/Callback;)V
...
.method public final a()Lokhttp3/Call;
    ...
    :cond_1
    iget-object v1, v5, Lretrofit2/RequestBuilder;->d:Lokhttp3/HttpUrl$Builder;
    ...
    iget-object v3, v5, Lretrofit2/RequestBuilder;->b:Lokhttp3/HttpUrl;
    ...
    :goto_2
    iget-object v3, v5, Lretrofit2/RequestBuilder;->k:Lokhttp3/RequestBody;

    if-nez v3, :cond_8

    iget-object v7, v5, Lretrofit2/RequestBuilder;->j:Lokhttp3/FormBody$Builder;
    ...
    :cond_4
    iget-object v7, v5, Lretrofit2/RequestBuilder;->i:Lokhttp3/MultipartBody$Builder;
    ...
    new-instance v7, Lokhttp3/RequestBody$Companion$toRequestBody$2;

    invoke-direct {v7, v2, v6, v3}, Lokhttp3/RequestBody$Companion$toRequestBody$2;-><init>(Lokhttp3/MediaType;I[B)V
    ...
    :cond_8
    :goto_3
    iget-object v2, v5, Lretrofit2/RequestBuilder;->g:Lokhttp3/MediaType;

    iget-object v6, v5, Lretrofit2/RequestBuilder;->f:Lokhttp3/Headers$Builder;
    ...
    :cond_a
    :goto_4
    iget-object v2, v5, Lretrofit2/RequestBuilder;->e:Lokhttp3/Request$Builder;
    ...
    iget-object p0, p0, Lretrofit2/OkHttpCall;->c:Lokhttp3/Call$Factory;
    ...
    invoke-static {v0, v2, v1}, Landroidx/activity/a;->t(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0, v1, v2}, Landroidx/activity/a;->r(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
...
.method public final c(Lokhttp3/Response;)Lretrofit2/Response;
    ...
    invoke-direct {v2, p1}, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;-><init>(Lokhttp3/ResponseBody;)V

    :try_start_0
    iget-object p0, p0, Lretrofit2/OkHttpCall;->d:Lretrofit2/Converter;

    invoke-interface {p0, v2}, Lretrofit2/Converter;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v0, p0, v1}, Lretrofit2/Response;-><init>(Lokhttp3/Response;Ljava/lang/Object;Lokhttp3/ResponseBody$Companion$asResponseBody$1;)V
    ...
    iget-object p1, v2, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;->d:Ljava/io/IOException;
    ...
    invoke-direct {p0, v0, v1, v1}, Lretrofit2/Response;-><init>(Lokhttp3/Response;Ljava/lang/Object;Lokhttp3/ResponseBody$Companion$asResponseBody$1;)V
    ...
    invoke-interface {v2, p0}, Lokio/BufferedSource;->L0(Lokio/BufferedSink;)J
    ...
    invoke-direct {v5, v2, v3, v4, p0}, Lokhttp3/ResponseBody$Companion$asResponseBody$1;-><init>(Lokhttp3/MediaType;JLokio/Buffer;)V
    ...
    invoke-direct {p0, v0, v1, v5}, Lretrofit2/Response;-><init>(Lokhttp3/Response;Ljava/lang/Object;Lokhttp3/ResponseBody$Companion$asResponseBody$1;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final clone()Ljava/lang/Object;
    ...
    iget-object v1, p0, Lretrofit2/OkHttpCall;->d:Lretrofit2/Converter;

    iget-object v2, p0, Lretrofit2/OkHttpCall;->a:Lretrofit2/RequestFactory;

    iget-object v3, p0, Lretrofit2/OkHttpCall;->b:[Ljava/lang/Object;

    iget-object p0, p0, Lretrofit2/OkHttpCall;->c:Lokhttp3/Call$Factory;

    invoke-direct {v0, v2, v3, p0, v1}, Lretrofit2/OkHttpCall;-><init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lokhttp3/Call$Factory;Lretrofit2/Converter;)V
...
.method public final declared-synchronized q()Lokhttp3/Request;
    .locals 3
    ...
    invoke-interface {v0}, Lokhttp3/Call;->q()Lokhttp3/Request;
